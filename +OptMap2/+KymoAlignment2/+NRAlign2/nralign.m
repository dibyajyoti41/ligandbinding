function [alignedKymo, stretchFactorsMat, shiftAlignedKymo, alignedMask, shiftAlignedKymoMask, shiftingVect, alignmentSuccessTF] = nralign(unalignedKymo, skipPrealignTF, kymoMask)
    ...
    if not(skipPrealignTF)
        import OptMap2.KymoAlignment2.NRAlign2.pre_nralign_shift_align;
        [shiftAlignedKymo, shiftingVect] = pre_nralign_shift_align(shiftAlignedKymo);
        try
        import OptMap2.KymoAlignment2.NRAlign2.shift_rows;
    ...
    import OptMap2.KymoAlignment2.apply_gaussian_blur;
    ...
    import OptMap2.KymoAlignment2.apply_laplacian_of_gaussian_filter;
    ...
    if alignmentSuccessTF
        ...
        import OptMap2.KymoAlignment2.find_k_features;
        ...
        if alignmentSuccessTF
            ...
            import OptMap2.KymoAlignment2.compute_stretch_factors;
            stretchFactorsMat = compute_stretch_factors(pathsColIdxs, imgSz);

            import OptMap2.KymoAlignment2.apply_horizontal_stretching;
